  ...
  return (
    <div className="h-screen bg-gray-50/50 flex font-sans overflow-hidden">
      ...
      <aside className="w-72 h-full bg-gradient-to-b from-blue-950 via-blue-900 to-blue-950 flex flex-col flex-shrink-0 shadow-2xl border-r border-blue-800/40">
        {/* Header */}
        <div className="px-6 py-6 border-b border-blue-800/60 flex items-center gap-3.5">
          ...
          <div>
            ...
            <p className="text-amber-400 text-xs lg:text-[13px] font-extrabold tracking-widest uppercase mt-1">Coordinator Panel</p>
          </div>
        </div>
          ...
          {NAV.map(({ label, href, icon: Icon }) => {
            ...
            return (
              <Link key={href} to={href}
                className={`flex items-center gap-3 pl-6 pr-4.5 py-3 rounded-xl text-sm lg:text-[15px] font-bold transition-all duration-200 ${
                  active
                ...
                <Icon size={18} className={active ? 'text-amber-400' : 'text-blue-300'} />
                <span>{label}</span>
              </Link>
            )
          })}
        ...
        <div className="px-6 py-6 border-t border-blue-800/60 bg-blue-950/40">
          <div className="flex items-center gap-3.5 mb-4">
            ...
            <div className="min-w-0">
              <p className="text-white text-sm lg:text-[16px] font-extrabold truncate">{user?.full_name}</p>
